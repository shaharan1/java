...
<form action="edit.jsp" method="post">
    ...
    <input type="email" name="custom1" value="<%=e.getCustom1()%>" > <br><br>
    <label for="">Date of Birth</label>
    <input type="date" name="custom2" value="<%=e.getCustom2()%>" > <br><br>
    <label for="">Fee</label>
    <input type="text" name="custom3" value="<%=e.getCustom3()%>"> <br><br>
